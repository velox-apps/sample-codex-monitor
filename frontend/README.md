...
CodexMonitor is a macOS desktop app for orchestrating multiple Codex agents across local workspaces. This repository contains a Swift/Velox port of the original Tauri/Rust app. The original Tauri version is preserved in `original/` for reference.
